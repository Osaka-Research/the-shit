...
# LLM replies go through Groq (GROQ_API_KEY, set in the Render dashboard) —
# no local model to build or download here anymore. Without GROQ_API_KEY,
# /api/reply just uses the canned stub replies.
